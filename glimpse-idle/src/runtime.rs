...
mod tests {
    ...
    #[test]
    fn app_id_is_stable() {
        assert_eq!(APP_ID, "me.aresa.GlimpseIdle");
    }

    #[test]
    fn test_instance_guard_rejects_second_owner() {
        let _first = TestInstanceGuard::acquire("me.aresa.GlimpseIdle.Test").expect("first");
        let second = TestInstanceGuard::acquire("me.aresa.GlimpseIdle.Test");
