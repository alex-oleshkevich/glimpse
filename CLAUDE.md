...
- **Languages:** rust (primary), , bash, contract, css, gitignore, go, image, javascript, js, json, markdown, py, python, spring, toml, yaml
- **Entry points:** `.agents/skills/ratatui-tui/assets/templates/async-app/src/main.rs`, `.agents/skills/ratatui-tui/assets/templates/component-app/src/main.rs`, `.agents/skills/ratatui-tui/assets/templates/hello-world/src/main.rs`, `.agents/skills/ratatui-tui/assets/templates/simple-app/src/main.rs`, `crates/glimpse-config/examples/gen_config_default.rs`, `crates/glimpse-config/examples/gen_config_schema.rs`, `crates/glimpse-lock/build.rs`, `crates/glimpse-lock/src/main.rs`, `crates/glimpse-panel/build.rs`, `crates/glimpse-panel/src/main.rs`, `crates/glimpse-sunset/build.rs`, `crates/glimpse-sunset/src/main.rs`, `crates/glimpse-wallpaper/build.rs`, `crates/glimpse-wallpaper/src/main.rs`, `crates/glimpse-widgets/build.rs`, `crates/glimpse-widgets/examples/preview.rs`, `crates/glimpsectl/build.rs`, `crates/glimpsectl/src/main.rs`, `crates/glimpsed/build.rs`, `crates/glimpsed/src/main.rs`, `scripts/calendar-fake-event.py`, `scripts/printing-mock-cups.py`, `scripts/sdk-e2e.py`, ``, `var/demo/demo.py`, `var/demo/sheet.py`
- **Most-referenced symbols:** `Debug` (374 usages), `Default` (280 usages), `Clone` (266 usages), `PartialEq` (252 usages), `clone` (247 usages), `Eq` (187 usages), `Deserialize` (166 usages), `gi.repository.Gtk` (142 usages), `Serialize` (124 usages), `Row` (124 usages)
- **Graph size:** 11453 nodes, 46610 edges
- **Breakdown:** 21 builtins, 242 constants, 2 contracts, 857 docs, 1003 fields, 443 files, 1087 functions, 85 generic_params, 6 images, 201 imports, 45 interfaces, 4 macros, 1287 methods, 109 modules, 251 packages, 1805 params, 1 strings, 1 todos, 769 types, 3234 variables
