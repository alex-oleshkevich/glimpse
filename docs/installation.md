...
Next, create your config file and choose what appears in the panel. Start with [Configuration](./configuration.md).
...
| Night light does not change color | Check [Sunset](./sunset.md). |
| Idle rules do nothing | Check [Idle](./idle.md). |
